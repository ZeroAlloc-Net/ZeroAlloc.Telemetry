...
| [Attribute Reference](https://github.com/ZeroAlloc-Net/ZeroAlloc.Telemetry/blob/main/docs/attributes.md) | `[Instrument]`, `[Trace]`, `[Count]`, `[Histogram]`, `[TraceTag]`, `[TraceTagFromResult]` |
